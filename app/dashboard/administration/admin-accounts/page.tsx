      ...
      <div className="flex flex-wrap gap-2">
        ...
        {ROLE_PRESETS.map((p) => (
          <button
            ...
            disabled={disabled}
            className="px-2 py-1 text-xs rounded border border-slate-200 hover:border-emerald-400 hover:text-brand-700 transition disabled:opacity-50"
            title={p.description}
          >
            {p.label}
          </button>
                      ...
                      <tr key={mod.key} className="border-b border-slate-100 hover:bg-slate-50/60 transition">
                        <td className="px-3 py-2 font-medium text-slate-700">
                          <button
                            ...
                            disabled={disabled}
                            className={cn(
                              'text-left hover:text-brand-700 transition disabled:cursor-default',
                              moduleAllChecked && 'text-brand-700 font-semibold'
                            )}
                      ...
                      <td className="px-4 py-3">
                        {u.admin_role === 'super_admin' ? (
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 text-xs text-slate-500 hover:text-brand-700 transition"
                          >
